...
class TestIntegration:
    ...
    def test_all_functions_available(self):
        ...
        for func_name in expected_functions:
            assert hasattr(utils_module, func_name), f"Function {func_name} should be available"
            assert callable(getattr(utils_module, func_name)), f"Function {func_name} should be callable"
