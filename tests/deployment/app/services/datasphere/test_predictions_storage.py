...
@pytest.mark.asyncio
async def test_save_predictions_to_db(
    ...
    result = await save_predictions_to_db(
    ...
    await verify_predictions_saved(temp_db["dal"], result, sample_predictions_data)


@pytest.mark.asyncio
async def test_save_predictions_to_db_invalid_path(monkeypatch, mock_get_db, temp_db):
...
@pytest.mark.asyncio
async def test_save_predictions_to_db_invalid_format(monkeypatch, mock_get_db, temp_db):
...
@pytest.mark.asyncio
async def test_save_predictions_to_db_missing_columns(
...
@pytest.mark.asyncio
async def test_save_predictions_to_db_db_connection_failure(temp_db, monkeypatch):
