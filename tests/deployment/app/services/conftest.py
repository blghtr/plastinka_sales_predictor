...
def mock_datasphere_env(temp_workspace, monkeypatch):
    ...
    patch_targets = [
        ...
        ('deployment.app.services.datasphere_service._archive_input_directory', mock_archive_input_directory),
        ('deployment.app.services.datasphere_service.get_db_connection', mock_get_db_connection),
    ]
