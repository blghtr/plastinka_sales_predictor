...
class TestDataRetention:
    ...
    @patch('deployment.app.db.data_retention.settings')
    @patch('deployment.app.db.data_retention.get_db_connection')
    def test_cleanup_old_predictions_success(self, mock_get_db, mock_settings, domain_db):
        ...
        mock_settings.data_retention = mock_retention
    ...
    @patch('deployment.app.db.data_retention.settings')
    def test_run_cleanup_job_success(self, mock_settings, mock_cleanup_historical, mock_cleanup_models, mock_cleanup_predictions):
