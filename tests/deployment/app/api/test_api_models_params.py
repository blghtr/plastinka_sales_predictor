...
class TestConfigEndpoints:
    ...
    def test_get_active_config_success(self, client, mock_dal, auth_header_name, auth_token):
        mock_dal.get_active_config.return_value = {"config_id": "active-config", "config": {}, "is_active": True}
        response = client.get("/api/v1/models-configs/configs/active", headers={auth_header_name: auth_token})
    ...
    def test_get_active_config_not_found(self, client, mock_dal, auth_header_name, auth_token):
    ...
    def test_activate_config_success(self, client, mock_dal, auth_header_name, auth_token):
        config_id = "config-to-activate"
        mock_dal.set_config_active.return_value = True
        response = client.post(f"/api/v1/models-configs/configs/{config_id}/set-active", headers={auth_header_name: auth_token})
        assert response.status_code == 200
    ...
    def test_activate_config_not_found(self, client, mock_dal, auth_header_name, auth_token):
    ...
    def test_get_best_config(self, client, mock_dal, auth_header_name, auth_token):
        mock_dal.get_best_config_by_metric.return_value = {"config_id": "best-config", "config": {"param": "value"}}
        response = client.get("/api/v1/models-configs/configs/best", headers={auth_header_name: auth_token})
        assert response.status_code == 200
    ...
    def test_get_configs_list(self, client, mock_dal, auth_header_name, auth_token):
        ...
        response = client.get("/api/v1/models-configs/configs", headers={auth_header_name: auth_token})
    ...
    def test_delete_configs(self, client, mock_dal, auth_header_name, auth_token):
        mock_dal.delete_configs_by_ids.return_value = {"successful": 1, "failed": 0, "errors": []}
        config_ids = [str(uuid.uuid4())]
        response = client.post("/api/v1/models-configs/configs/delete", json={"ids": config_ids}, headers={auth_header_name: auth_token})
        assert response.status_code == 200
    ...
    def test_upload_config(self, client, mock_dal, auth_header_name, auth_token):
        ...
        response = client.post("/api/v1/models-configs/configs/upload", json=request_data, headers={auth_header_name: auth_token})
        assert response.status_code == 200
...
class TestModelEndpoints:
    ...
    def test_get_active_model(self, client, mock_dal, auth_header_name, auth_token):
        mock_dal.get_active_model.return_value = {"model_id": "active-model", "model_path": "/fake/path", "metadata": {}}
        response = client.get("/api/v1/models-configs/models/active", headers={auth_header_name: auth_token})
        assert response.status_code == 200
    ...
    def test_activate_model(self, client, mock_dal, auth_header_name, auth_token):
        model_id = "model-to-activate"
        mock_dal.set_model_active.return_value = True
        response = client.post(f"/api/v1/models-configs/models/{model_id}/set-active", headers={auth_header_name: auth_token})
        assert response.status_code == 200
    ...
    def test_get_best_model(self, client, mock_dal, auth_header_name, auth_token):
        mock_dal.get_best_model_by_metric.return_value = {"model_id": "best-model", "model_path": "/path", "metadata": {}, "metrics": {}}
        response = client.get("/api/v1/models-configs/models/best", headers={auth_header_name: auth_token})
        assert response.status_code == 200
    ...
    def test_get_recent_models(self, client, mock_dal, auth_header_name, auth_token):
        ...
        response = client.get("/api/v1/models-configs/models/recent", headers={auth_header_name: auth_token})
        assert response.status_code == 200
        assert isinstance(response.json(), list)
        assert len(response.json()) == 2
    ...
    def test_get_all_models(self, client, mock_dal, auth_header_name, auth_token):
        ...
        response = client.get("/api/v1/models-configs/models", headers={auth_header_name: auth_token})
        assert response.status_code == 200
    ...
    def test_delete_models(self, client, mock_dal, auth_header_name, auth_token):
        ...
        response = client.post("/api/v1/models-configs/models/delete", json={"ids": model_ids}, headers={auth_header_name: auth_token})
    ...
    def test_upload_model(self, monkeypatch, client, mock_dal, auth_header_name, auth_token):
        # 1. Mock settings
